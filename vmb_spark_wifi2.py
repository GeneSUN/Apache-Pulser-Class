...
def read_vmb_dataframe(date_str):
    models_vcg = ['ASK-NCQ1338', 'ASK-NCQ1338FA', 'XCI55AX','CR1000A','WNC-CR200A']

    df_vcg = spark.read.parquet(hdfs_title + f"/user/ZheS/wifi_score_v3/homeScore_dataframe/{date_str}")\
    ...
    df_vcg = df_vcg.filter( col("dg_model_indiv").isin(models_vcg) )\
...
if __name__ == "__main__":
    ...
    try:
        ...
        df_vcg = read_vmb_dataframe(date_str, sample_num = None)
